...
import { ArrowLeftRight, Lock, TrendingUp, BarChart2 } from "lucide-react";

interface ProtectedTradingProps {
  children: React.ReactNode;
}

export default function ProtectedTrading({ children }: ProtectedTradingProps) {
        ...
        <div className="min-h-[80vh] w-full bg-gradient-to-b from-[#111827] to-[#0c111b] rounded-lg overflow-hidden shadow-xl flex flex-col">
          ...
          <div className="relative p-8 flex-grow flex flex-col items-center justify-center text-center">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="text-gray-300 text-xl mb-8">
                Create an account to access advanced trading features and
                simulations
              </p>
          ...
          <div className="bg-black/30 p-12 grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center text-center">
              <ArrowLeftRight className="w-12 h-12 text-emerald-500 mb-4" />
              <h3 className="text-white text-xl font-medium mb-3">
                Advanced Trading
              </h3>
              <p className="text-gray-400">
                Execute trades with professional tools and real-time data
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-400">
                Track your trading history and analyze performance trends
              </p>
            </div>
          </div>
        </div>
