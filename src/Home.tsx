...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Header with Login, Signup, and Settings */}
      <div className="bg-blue-900 text-white py-4 px-6 flex justify-end items-center gap-4">
        <button 
      ...
      >
        {close => (
          <div className="modal bg-white rounded-lg p-6 w-96">
            <button className="close absolute top-4 right-4" onClick={close}>
              &times;
            </button>
